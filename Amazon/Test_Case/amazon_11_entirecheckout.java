...
public class amazon_11_entirecheckout extends Data_fetching_excel
{
	WebDriver driver;
	...
	public void entire_checkout() throws EncryptedDocumentException, IOException, InterruptedException
	{
		Data_fetching_excel ddt = new Data_fetching_excel();
		ddt.data_fetch();
		
		
		amazon_11_go_cart_filldetails go_cart = new amazon_11_go_cart_filldetails(driver);
